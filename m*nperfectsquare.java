/*Write a program that prompts the user to enter an integer m and find the smallest integer n such that m * n is a perfect square. Implement using Arraylist.

Input Format

A single line contains the integers m.

Output Format

A single line contains the smallest number n for m * n to be a perfect square.*/
